...
contract RingBufferLibWrapper {
  ...
  function newestIndex(uint256 _nextIndex, uint256 _cardinality) external pure returns (uint256) {
  ...
  function nextIndex(uint256 _index, uint256 _cardinality) external pure returns (uint256) {
  ...
  function prevIndex(uint256 _index, uint256 _cardinality) external pure returns (uint256) {
